package egovframework.survey.qri.web;
...
import egovframework.survey.qri.service.QustnrRespondInfoService;
import egovframework.survey.qri.service.QustnrRespondInfoVO;
...
public class QustnrRespondInfoController {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(QustnrRespondInfoController.class);
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/survey/template/template"
	 * @throws Exception
	 */
	@RequestMapping(value="/survey/qri/template/template")
    ...
    throws Exception {
		...
		LOGGER.debug("templateUrl=> {}", commandMap.get("templateUrl"));
 		...
 		//설문템플릿정보
		model.addAttribute("QustnrTmplatManage",  qustnrRespondInfoService.selectQustnrTmplatManage(commandMap));

    	//설문정보
    	model.addAttribute("Comtnqestnrinfo",  qustnrRespondInfoService.selectQustnrRespondInfoManageComtnqestnrinfo(commandMap));
    	//문항정보
    	model.addAttribute("Comtnqustnrqesitm",  qustnrRespondInfoService.selectQustnrRespondInfoManageComtnqustnrqesitm(commandMap));
    	//항목정보
    	model.addAttribute("Comtnqustnriem",  qustnrRespondInfoService.selectQustnrRespondInfoManageComtnqustnriem(commandMap));
    	//설문템플릿ID 설정
        ...
        //객관식통계 답안
    	model.addAttribute("qestnrStatistic1", qustnrRespondInfoService.selectQustnrRespondInfoManageStatistics1(commandMap));

        //주관식통계 답안
    	model.addAttribute("qestnrStatistic2", qustnrRespondInfoService.selectQustnrRespondInfoManageStatistics2(commandMap));
		...
		// 화이트 리스트 체크
		List<?> popupWhiteList = qustnrRespondInfoService.selectQustnrTmplatWhiteList();
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/survey/qnn/qustnrRespondInfoManageStatistics"
	 * @throws Exception
	 */
	@RequestMapping(value="/survey/qnn/qustnrRespondInfoManageStatistics.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/survey/qnn/qustnrRespondInfoManageStatistics";
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/survey/qnn/qustnrRespondInfoManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="설문조사", order = 600 ,gid = 50)
	@RequestMapping(value="/survey/qnn/qustnrRespondInfoManageList.do")
    ...
    throws Exception {
        ...
        List<?> sampleList = qustnrRespondInfoService.selectQustnrRespondInfoManageList(searchVO);
	 ...
	 * @param commandMap
	 * @param model
	 * @return "egovframework/survey/qnn/qustnrRespondInfoManageRegist"
	 * @throws Exception
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@RequestMapping(value="/survey/qnn/qustnrRespondInfoManageRegist.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/survey/qnn/qustnrRespondInfoManageRegist";
        ...
        if(sCmd.equals("save")){
        	...
        	sLocationUrl = "forward:/survey/qnn/qustnrRespondInfoManageList.do";
        }else{

        	 if(loginVO.getUniqId() != null){
	        	 commandMap.put("uniqId", loginVO.getUniqId());
	        	 //사용자정보
	        	 model.addAttribute("Emplyrinfo",  qustnrRespondInfoService.selectQustnrRespondInfoManageEmplyrinfo(commandMap));
        	 }
	 ...
	 * @param model
	 * @return "egovframework/survey/qri/qustnrRespondInfoList"
	 * @throws Exception
	 */
	@RequestMapping(value="/survey/qri/qustnrRespondInfoList.do")
    ...
    throws Exception {
        ...
        List<?> sampleList = qustnrRespondInfoService.selectQustnrRespondInfoList(searchVO);
        model.addAttribute("resultList", sampleList);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/survey/qri/qustnrRespondInfoDetail.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/survey/qri/qustnrRespondInfoDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			qustnrRespondInfoService.deleteQustnrRespondInfo(qustnrRespondInfoVO);
			sLocationUrl = "redirect:/survey/qri/qustnrRespondInfoList.do";
		}else{
	        List<?> sampleList = qustnrRespondInfoService.selectQustnrRespondInfoDetail(qustnrRespondInfoVO);
	        model.addAttribute("resultList", sampleList);
		}
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/survey/qri/qustnrRespondInfoModify"
	 * @throws Exception
	 */
	@RequestMapping(value="/survey/qri/qustnrRespondInfoModify.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/survey/qri/qustnrRespondInfoModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "egovframework/survey/qri/qustnrRespondInfoRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/survey/qri/qustnrRespondInfoRegist.do")
    ...
    throws Exception {
		...
		String sLocationUrl = "egovframework/survey/qri/qustnrRespondInfoRegist";
