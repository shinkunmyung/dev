<%--
  Class Name : qustnrQestnManageStatistics.jsp
...
<div class="wTableFrm">
	...
	<div class="btn">
		<!-- 목록 버튼 -->
		<form name="QustnrQestnManageForm" action="<c:url value='/survey/qqm/qustnrQestnManageList.do'/>" method="post" onsubmit="fn_egov_list_QustnrQestnManage(); return false;" style="float:left;">
