<%--
  Class Name : qustnrQestnManageModify.jsp
...
function fn_egov_save_QustnrQestnManage(){
	...
	if(confirm("<spring:message code='common.save.msg' />")){
		//varFrom.action =  "<c:url value='/survey/qqm/qustnrQestnManageModify.do' />";
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form commandName="qustnrQestnManageVO" name="qustnrQestnManageVO" action="${pageContext.request.contextPath}/survey/qqm/qustnrQestnManageModify.do" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrQestnManage(document.forms[0]); return false;">
