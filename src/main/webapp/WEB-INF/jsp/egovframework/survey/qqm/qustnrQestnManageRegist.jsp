<%--
  Class Name : qustnrQestnManageRegist.jsp
...
function fn_egov_list_QustnrQestnManage(){
	...
	varFrom.action =  "<c:url value='/survey/qqm/qustnrQestnManageList.do' />";
	varFrom.submit();
...
<form commandName="qustnrQestnManageVO" id="qustnrQestnManageVO" action="<c:url value='/survey/qqm/qustnrQestnManageRegist.do' />" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrQestnManage(document.forms[0]); return false;">
...
<div class="wTableFrm">
	...
	<tbody >
		...
		<tr>
			...
			<td class="left">
  				<input name="qestnrCn" id="qestnrCn" title="<spring:message code='comUssOlpQqm.regist.qestnrCn'/>
  					<spring:message code='input.input'/>" type="text" size="73" value="${qestnrInfo.qustnrSj}" maxlength="2000" style="width:300px;" disabled="disabled"><!-- title="설문지정보(제목) 입력" -->
	...
	<div class="btn">
		...
		<!-- 목록버튼 -->
		<span class="btn_s"><a href="<c:url value='/survey/qqm/qustnrQestnManageList.do' />"  title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
