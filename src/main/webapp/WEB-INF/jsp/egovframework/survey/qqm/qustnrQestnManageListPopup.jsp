...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/survey/qqm/qustnrQestnManageListPopup.do'/>";
...
function fn_egov_search_QustnrQestnManage(){
	...
	vFrom.action = "<c:url value='/survey/qqm/qustnrQestnManageListPopup.do' />";
	vFrom.submit();
...
<form name="ListForm" action="<c:url value='/survey/qqm/qustnrQestnManageListPopup.do'/>" method="post" onSubmit="fn_egov_search_QustnrQestnManage(); return false;">
