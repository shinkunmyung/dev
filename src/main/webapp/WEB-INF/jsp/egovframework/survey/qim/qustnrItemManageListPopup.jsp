<%--
  Class Name : qustnrItemManageListPopup.jsp
...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/survey/qim/qustnrItemManageListPopup.do'/>";
...
function fn_egov_regist_QustnrItemManage(){
	self.href = "<c:url value='/survey/qim/qustnrItemManageRegist.do' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
//function fn_egov_modify_QustnrItemManage(){
//	self.href = "<c:url value='/survey/qim/qustnrItemManageModify.do' />";
//}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_QustnrItemManage(qustnrIemId){
	...
	vFrom.action = "<c:url value='/survey/qim/qustnrItemManageDetail.do' />";
	vFrom.submit();
}
/* ********************************************************
 * 삭제 처리 함수
...
function fn_egov_delete_QustnrItemManage(qestnrId){
	...
	if(confirm("<spring:message code='common.delete.msg'/>")){ //삭제 하시겠습니까?
		...
		vFrom.cmd.value = 'del';
		vFrom.action = "<c:url value='/survey/qim/qustnrItemManageList.do' />";
		vFrom.submit();
	}else{
		vFrom.cmd.value = '';
	}
...
<form name="ListForm" action="<c:url value='/survey/qim/qustnrItemManageListPopup.do'/>" method="post" onSubmit="fn_egov_search_QustnrItemManage(); return false;">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			...
			<li>
				...
				<!-- 등록버튼 -->
				<span class="btn_r" > <a href="<c:url value='/survey/qim/qustnrItemManageRegist.do'/>" title="<spring:message code='button.create' /> <spring:message code='input.button' />"><spring:message code="button.create" /></a></span>
