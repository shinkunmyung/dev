<%--
  Class Name : qustnrItemManageRegist.jsp
...
function fn_egov_list_QustnrItemManage(){
	location.href = "<c:url value='/survey/qim/qustnrItemManageList.do' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_QustnrItemManage(){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		...
		varFrom.action =  "<c:url value='/survey/qim/qustnrItemManageRegist.do' />";
 ...
 ******************************************************** */
 function fn_egov_QustnrManageListPopup_QustnrItemManage(){
 	...
 	window.showModalDialog("<c:url value='/survey/qmc/qustnrManageListPopup.do' />", self,"dialogWidth:800px;dialogHeight:500px;resizable:yes;center:yes");
  ...
  ******************************************************** */
  function fn_egov_QustnrQestnManageListPopup_QustnrItemManage(){
	...
	sParam = sParam + "&searchKeyword=" + document.getElementById("qestnrId").value;
  	...
  	window.showModalDialog("<c:url value='/survey/qqm/qustnrQestnManageListPopup.do' />?" + sParam, self,"dialogWidth:800px;dialogHeight:500px;resizable:yes;center:yes");
...
<form:form commandName="qustnrItemManageVO" action="${pageContext.request.contextPath}/survey/qim/qustnrItemManageRegist.do" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrItemManage(document.forms[0]); return false;">
...
<div class="wTableFrm">
	...
	<tbody >
		...
		<tr>
			...
			<td class="left">
  				<input name="qestnrCn" id="qestnrCn" type="text" size="73" value="${qustnrQestnManageDetail[0].qestnrSj}" title="<spring:message code='comUssOlpQim.regist.qestnrCn'/><spring:message code='input.input'/>" maxlength="4000" style="width:300px;" disabled="disabled"><!-- title="설문정보 입력" -->
			    ...
			    <input name="qestnrId" id="qestnrId" type="hidden" value="${qustnrQestnManageDetail[0].qestnrId}">
			    <input name="qestnrTmplatId" id="qestnrTmplatId" type="hidden" value="${qustnrQestnManageDetail[0].qestnrTmplatId}">
		...
		<tr>
			...
			<td class="nopd">
				<input name="qestnrQesitmCn" id="qestnrQesitmCn" type="text" title="<spring:message code='comUssOlpQim.regist.qestnrQesitmCn'/><spring:message code='input.input'/>" size="73" value="${qustnrQestnManageDetail[0].qestnCn}" maxlength="4000" style="width:300px;" disabled="disabled"><!-- title="설문문항정보 입력" -->
  				...
  				<input name="qestnrQesitmId" id="qestnrQesitmId" type="hidden" value="${qustnrQestnManageDetail[0].qestnrQesitmId} ">
			</td>
		</tr>
		<!-- 항목순번 -->
	...
	<div class="btn">
		...
		<!-- 목록버튼 -->
		<span class="btn_s"><a href="<c:url value='/survey/qim/qustnrItemManageList.do' />"  title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
