<%--
  Class Name : qustnrItemManageModify.jsp
...
function fn_egov_save_QustnrItemManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/survey/qim/qustnrItemManageModify.do' />";
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form commandName="qustnrItemManageVO" name="qustnrItemManageVO" action="${pageContext.request.contextPath}/survey/qim/qustnrItemManageModify.do" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrItemManage(document.forms[0]); return false;">
