...
function fn_egov_save_QustnrRespondInfo(){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		...
		varFrom.action =  "<c:url value='/survey/qri/qustnrRespondInfoRegist.do' />";
...
<form:form commandName="qustnrRespondInfoVO" action="${pageContext.request.contextPath}/survey/qri/qustnrRespondInfoRegist.do" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrRespondInfo(document.forms[0]); return false;">
