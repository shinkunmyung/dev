<%--
  Class Name : qustnrRespondInfoModify.jsp
...
function fn_egov_list_QustnrRespondInfo(){
	location.href = "<c:url value='/survey/qri/qustnrRespondInfoList.do' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_QustnrRespondInfo(){
	...
	if(confirm("<spring:message code='common.save.msg' />")){
		varFrom.action =  "<c:url value='/survey/qri/qustnrRespondInfoModify.do' />";
...
function fn_egov_QustnrItemManageListPopup_QustnrItemManage(){
	...
	sParam = sParam + "&searchKeyword=" + document.getElementById("qestnrQesitmId").value;
  	...
  	window.showModalDialog("<c:url value='/survey/qim/qustnrItemManageListPopup.do' />?" + sParam, self,"dialogWidth:800px;dialogHeight:500px;resizable:yes;center:yes");
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form commandName="qustnrRespondInfoVO" name="qustnrRespondInfoVO" action="${pageContext.request.contextPath}/survey/qri/qustnrRespondInfoModify.do" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrRespondInfo(document.forms[0]); return false;">
...
<div class="btn">
	...
	<!-- 목록버튼 -->	
	<span class="btn_s"><a href="<c:url value='/survey/qri/qustnrRespondInfoList.do' />"   title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
