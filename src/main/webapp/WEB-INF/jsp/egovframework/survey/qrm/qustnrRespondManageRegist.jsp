<%--
  Class Name : qustnrRespondManageRegist.jsp
...
function fn_egov_save_QustnrRespondManage(){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		...
		//varFrom.action =  "<c:url value='/survey/qrm/qustnrRespondManageRegist.do'/>";
		//varFrom.action =  "${pageContext.request.contextPath}/survey/qrm/qustnrRespondManageRegist.do";
		document.getElementById("qustnrRespondManageVO").action = "${pageContext.request.contextPath}/survey/qrm/qustnrRespondManageRegist.do";
