<%--
  Class Name : qustnrTmplatManageModify.jsp
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form commandName="qustnrTmplatManageVO" name="qustnrTmplatManageVO" action="${pageContext.request.contextPath}/survey/qtm/qustnrTmplatManageModifyActor.do" method="post" enctype="multipart/form-data" >

<!-- 첨부파일 개수 설정을 위한 Hidden 설정 -->
<input type="hidden" name="posblAtchFileNumber" id="posblAtchFileNumber" value="3" />

<!-- 첨부파일 삭제 후 리턴 URL -->
<input type="hidden" name="returnUrl" value="<c:url value='/survey/qtm/qustnrTmplatManageModify.do'/>"/>
