<%--
  Class Name : qustnrManageRegist.jsp
...
<form:form commandName="qustnrManageVO" action="${pageContext.request.contextPath}/survey/qmc/qustnrManageRegist.do" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrManage(document.forms[0]); return false;">
