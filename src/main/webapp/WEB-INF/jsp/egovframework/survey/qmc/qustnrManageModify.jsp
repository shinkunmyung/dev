<%--
  Class Name : qustnrManageModify.jsp
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form commandName="qustnrManageVO" name="qustnrManageVO" action="${pageContext.request.contextPath}/survey/qmc/qustnrManageModify.do" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrTmplatManage(document.forms[0]); return false;">
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
				...
				<td><img src="<c:url value='/survey/qtm/qustnrTmplatManageImg.do' />?qestnrTmplatId=${resultQustnrTmplat.qestnrTmplatId}" align="middle" alt="<spring:message code='comUssOlpQmc.regist.qestnrTmplatTy'/><spring:message code='comUssOlpQmc.title.image'/>" title="<spring:message code='comUssOlpQmc.regist.qestnrTmplatTy'/><spring:message code='comUssOlpQmc.title.image'/>"></td><!-- alt="템플릿유형 이미지" title="템플릿유형 이미지" -->
				</c:forEach>
				</tr>
				<tr>
				<c:forEach items="${listQustnrTmplat}" var="resultQustnrTmplat" varStatus="status">
...
<div class="btn">
	...
	<!-- 목록버튼 -->	
	<span class="btn_s"><a href="<c:url value='/survey/qmc/qustnrManageList.do' />"   title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
