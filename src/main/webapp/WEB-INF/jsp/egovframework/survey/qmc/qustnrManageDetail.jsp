<%--
  Class Name : qustnrManageDetail.jsp
...
function fn_egov_list_QustnrManage(){
	location.href = "<c:url value='/survey/qmc/qustnrManageList.do' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_modify_QustnrManage(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/survey/qmc/qustnrManageModify.do' />";;
	vFrom.submit();
...
<div class="wTableFrm">
<form name="QustnrTmplatManageForm" id="QustnrTmplatManageForm" action="<c:url value='/survey/qmc/qustnrManageModify.do'/>" method="post">
	<!-- 타이틀 -->
	...
	<div class="btn">
		<!-- 수정 버튼 -->
		<form name="formUpdt" action="<c:url value='/survey/qmc/qustnrManageModify.do'/>" method="post" onsubmit="fn_egov_modify_QustnrManage(); return false;" style="float:left;">
		<input type="submit" class="s_submit" value="<spring:message code='button.update' />" title="<spring:message code='title.update' /> <spring:message code='input.button' />" />
		<input name="qestnrId" type="hidden" value="${resultList[0].qestnrId}">
		</form>
		<!-- 삭제 버튼 -->
		<form name="formDelete" action="<c:url value='/survey/qmc/qustnrManageDetail.do'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<!-- 목록 버튼 -->
		<form name="formList" action="<c:url value='/survey/qmc/qustnrManageList.do'/>" method="post" style="float:left; margin:0 0 0 3px;">
