<%--
  Class Name : qustnrManageListPopup.jsp
...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/survey/qmc/qustnrManageListPopup.do'/>";
...
function fn_egov_search_QustnrManage(){
	...
	vFrom.action = "<c:url value='/survey/qmc/qustnrManageListPopup.do' />";
	vFrom.submit();
...
<form name="ListForm" action="<c:url value='/survey/qmc/qustnrManageListPopup.do'/>" method="post" onSubmit="fn_egov_search_QustnrManage(); return false;">
