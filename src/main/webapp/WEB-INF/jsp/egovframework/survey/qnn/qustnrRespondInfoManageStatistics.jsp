<%--
  Class Name : qustnrRespondInfoManageStatistics.jsp
  Description : 설문지 통계
...
<div class="wTableFrm">
	...
	<div class="btn">
		<!-- 목록 버튼 -->
		<form name="QustnrQestnManageForm" action="<c:url value='/survey/qnn/qustnrRespondInfoManageList.do'/>" method="post" onsubmit="fn_egov_list_QustnrRespondInfo(); return false;" style="float:left;">
