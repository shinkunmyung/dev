<%--
  Class Name : qustnrRespondInfoManageRegist.jsp
...
function fn_egov_list_QustnrRespondInfo(){
	location.href = "/survey/qnn/qustnrRespondInfoManageList.do";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_QustnrRespondInfo(){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		...
		//varFrom.action =  "${pageContext.request.contextPath}/survey/qnn/qustnrRespondInfoManageRegist.do";
		varFrom.action =  "<c:url value='/survey/qnn/qustnrRespondInfoManageRegist.do'/>";
		varFrom.submit();
...
<form:form name="qustnrRespondInfoManage" id="qustnrRespondInfoManage" action="${pageContext.request.contextPath}/survey/qnn/qustnrRespondInfoManageRegist.do" method="post">
...
<div class="wTableFrm">
	...
	<tbody >	
		...
		<c:import charEncoding="utf-8" url="/survey/qri/template/template.do" >
	...
	<div class="btn">
		...
		<!-- 목록버튼 -->
		<span class="btn_s"><a href="<c:url value='/survey/qnn/qustnrRespondInfoManageList.do' />"  title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
