<%--
  Class Name : qustnrRespondInfoManageList.jsp
...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/survey/qnn/qustnrRespondInfoManageList.do'/>";
...
function fn_egov_search_QustnrManage(){
	...
	vFrom.action = "<c:url value='/survey/qnn/qustnrRespondInfoManageList.do'/>";
	vFrom.submit();
 ...
 ******************************************************** */
 ...
 function fn_egov_regist_QustnrRespondInfoManage(qestnrId, qestnrTmplatId){
 	 ...
 	 //document.listForm.action = "<c:url value='${pageContext.request.contextPath}/survey/qnn/qustnrRespondInfoManageRegist.do'/>";
 	 document.listForm.action = "<c:url value='/survey/qnn/qustnrRespondInfoManageRegist.do'/>";
 	 document.listForm.submit();
 }
...
function fn_egov_statistics_QustnrRespondInfoManage(qestnrId, qestnrTmplatId){
 	 ...
 	 document.getElementById("qestnrId").value = qestnrId;
 	 document.getElementById("qestnrTmplatId").value = qestnrTmplatId;
 	 document.listForm.action = "<c:url value='/survey/qnn/qustnrRespondInfoManageStatistics.do'/>";
 	 document.listForm.submit();
}
</script>
</head>
...
<form name="listForm" id="listForm" action="<c:url value='/survey/qnn/qustnrRespondInfoManageList.do'/>" method="post" >
...
<!-- </form> -->
	...
	<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	  <tr>
		...
		<!-- 설문제목  -->
		<td class="lt_text3L">
			<a href="<c:url value='/survey/qnn/qustnrRespondInfoManageRegist.do'/>?qestnrId=${resultInfo.qestnrId}&qestnrTmplatId=${resultInfo.qestnrTmplatId}" onClick="fn_egov_regist_QustnrRespondInfoManage('<c:out value="${resultInfo.qestnrId}"/>','<c:out value="${resultInfo.qestnrTmplatId}"/>');return false;"><c:out value='${resultInfo.qestnrSj}'/></a> 
		</td>
		<!-- 설문기간 -->
